 ...
 *amount of movesto the exact moves to exactly the amount of total players.
...
class pi25b495 : public Player {
    public:
        ...
        Move play(const State& s) override { // to override einai perisseio
            ...
            size_t leastAmountOfPossibleMoves = 0;
            ...
            if (leastAmountOfPossibleMoves > s.getPlayers() + 1) {
            ...
            } else if (leastAmountOfPossibleMoves > s.getPlayers()) { //== s.getPlayers() + 1
